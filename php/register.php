...
<?php
 ...
 if (isset($validusername) && isset($validpassword) && isset($validfirstname) && isset($validlastname) && isset($validphone) && isset($validemail)) {
		...
		if (mysqli_num_rows($result) == 1){		//if username already exists on the server...
			...
			$sql = "INSERT INTO user (username,password,firstname,lastname,phone,email) VALUES ('$username','$password','$firstname','$lastname','$phone','$email')";			//creates a new entry in account table containing the user defined variable inputs...
